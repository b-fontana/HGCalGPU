  ...
  token_(consumes<HGCUncalibratedRecHitCollection>(ps.getParameter<edm::InputTag>("HGCHEFUncalibRecHitsTok")))
{
  ...
  histo4_ = fs->make<TH1F>( "son"  , "son", 100,  0., 10. );
...
edm::SortedCollection<HGCRecHit> HeterogeneousHGCalHEFRecHitProducer::convert_soa_data_to_collection_(HGCRecHitSoA *d, const unsigned int& nhits)
{
